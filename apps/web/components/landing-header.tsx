...
export function Header() {
  ...
  const [themeVar, setThemeVar] = useState<string | undefined>("");
  ...
  return (
    <header className="border-b fixed top-0 z-50 left-0 right-0 dark:bg-black/95 backdrop-blur dark:supports-[backdrop-filter]:bg-black/60">
      <div className="container flex h-14 max-w-screen-2xl items-center">
        ...
        <nav className="flex flex-1 items-center justify-end mr-4 space-x-4">
          <Link href="https://github.com/Pratiyankkumar">
            <div className=" h-9 flex items-center justify-center  mr-4 w-9 rounded-md transition-all duration-200 hover:bg-accent">
              {themeVar === "light" ? (
                <svg
                  ...
                  height="100"
                  viewBox="0 0 30 30"
                  className="h-6 w-6 rotate-0 transition-all duration-200 dark:-rotate-90 dark:scale-0 "
                >
          ...
          <Link href="https://x.com/pratiyank">
            <div className="h-9 flex items-center justify-center  mr-4 w-9 rounded-md transition-all duration-200 hover:bg-accent">
              {themeVar === "light" ? (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
